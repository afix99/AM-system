...
export function ClaudeSparkle({ size = 64, className = "" }: Props) {
  return (
    <span
      className={`inline-flex items-center justify-center claude-bot-glow ${className}`}
    ...
    >
      <svg viewBox="0 0 100 100" width={size} height={size}>
        ...
        <circle cx="50" cy="50" r="48" fill="url(#claudeHalo)" className="claude-bot-halo" />
        <g className="claude-bot-body">
          <path
            d="M50 2 C 53 38, 56 41, 98 50 C 56 59, 53 62, 50 98 C 47 62, 44 59, 2 50 C 44 41, 47 38, 50 2 Z"
            fill="url(#claudeCore)"
          />
          <path
            d="M50 2 C 53 38, 56 41, 98 50 C 56 59, 53 62, 50 98 C 47 62, 44 59, 2 50 C 44 41, 47 38, 50 2 Z"
          ...
          />
          <circle cx="50" cy="50" r="9" fill="#FFF1E1" opacity="0.95" className="claude-bot-eye" />
        </g>
      </svg>
    </span>
  );
