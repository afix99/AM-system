...
export function Button({ variant = "primary", size = "md", className, children, ...props }: ButtonProps) {
  const base = "btn-pop inline-flex items-center justify-center gap-2 font-medium rounded-lg disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:active:scale-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D97756]/50 focus-visible:ring-offset-1 focus-visible:ring-offset-[#1C1917]";
  const variants = {
